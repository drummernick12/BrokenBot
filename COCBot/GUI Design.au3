...
;$WallMinGold = GUICtrlCreateLabel(GetLangText("WallMinGold"), 275, 92, 76, 17)
...
;GUICtrlSetLimit(-1, 7)
$WallMinGold = GUICtrlCreateLabel(GetLangText("WallMinGold"), 50, 140, 100, 17)
GUICtrlSetTip(-1, GetLangText("WallMinGoldTip"))
...
;$WallMinElixir = GUICtrlCreateLabel(GetLangText("WallMinElixir"), 275, 117, 72, 17)
...
;GUICtrlSetLimit(-1, 7)
$WallMinElixir = GUICtrlCreateLabel(GetLangText("WallMinElixir"), 230, 140, 100, 17)
GUICtrlSetTip(-1, GetLangText("WallMinElixirTip"))
$txtWallMinElixir = GUICtrlCreateInput("1300000", 300, 135, 61, 21, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
GUICtrlSetLimit(-1, 7)

;$UseGoldElix = GUICtrlCreateRadio(GetLangText("UseGoldElix"), 40, 237, 150, 17)
